...
class EventEmitter(object):
    ...
    def on_all(self, f=None):
        def _on_all(f):
            self._add_all_event_handler(f)
            return f
    ...
    def _add_all_event_handler(self, f):
        self._all_handlers.append(f)
    ...
    def emit(self, event, *args, **kwargs):
        ...
        to_handle = list(self._events[event].values()) + self._all_handlers
        for f in to_handle:
